...
int arithmetic1_lgsr::decrypt(unsigned char *pkt, int len)
{
    ...
    //cout<<"arithmetic1_lgsr::decrypt:"<<__LINE__<<endl;
    //printn(pkt,len);
...
int arithmetic1_lgsr::get_checksum(unsigned char *pkt, int len)
{
    ...
    {
        //printf("%x,%x\n",checksum,*((unsigned short*)(pkt+i)));
        checksum = checksum ^ *((unsigned short*)(pkt+i));
    }
    //printf("%x,%x\n",checksum,*((unsigned short*)(pkt+14)));
    //printf("%x\n",checksum);
...
int arithmetic1_lgsr::xor_operation(unsigned char* msg,int len)
{
    ...
    //printf("kindex,random:%x,%x\n",p_encrypt_char->_k_index,p_encrypt_char->_random);
