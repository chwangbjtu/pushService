...
namespace netsvc{
	...
	template<class handler>
	//epoll_accepter<handler>::epoll_accepter():_listen_port(0),_listen_sock(-1),_accepter_stop(true),_worker_num(0),_hd_counter(0),_arg(NULL),_max_conns(2000000),_max_events(2048),_max_waittm(50),_dispatch(round)
	epoll_accepter<handler>::epoll_accepter():_listen_port(0),_listen_sock(-1),_accepter_stop(true),_worker_num(0),_hd_counter(0),_arg(NULL),_max_conns(2000000),_max_events(512),_max_waittm(50),_dispatch(round)
	{
